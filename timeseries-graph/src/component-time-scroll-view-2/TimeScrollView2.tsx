...
const TimeScrollView2: FunctionComponent<Props> = ({width, height, onCanvasElement, gridlineOpts, onKeyDown, onMouseDown, onMouseMove, onMouseOut, onMouseUp, hideToolbar, yAxisInfo, shiftZoom, additionalToolbarItems, showTimeSelectionBar, leftMargin}) => {
    const { currentTimeSec, visibleStartTimeSec, visibleEndTimeSec, zoomTimeSelection, panTimeSelectionPct } = useTimeseriesSelection()
    ...
    }, [shiftZoom, zoomTimeSelection, hoverTime])
    ...
    return (
        <div className="TimeScrollView2" ref={divRef} style={{position: 'absolute', width, height, overflow: 'hidden'}}>
            <Splitter
                // ref={divRef}
                width={width}
                height={height}
